...
public class Utilities {
	...
	public static void mainMenu() {
		System.out.println("\u001B[107m" + "\u001B[32m" + "+--Marcelino Gil Nombela Database--+");
		System.out.print("\u001B[0m");
		System.out.println("\u001B[32m" + "1-Create the table and add data");
		System.out.println("\u001B[32m" + "2-Find and show data");
		System.out.println("\u001B[32m" + "3-Modify data");
		System.out.println("\u001B[32m" + "4-Remove data");
	...
	/**
	 * Shows a message and receives a String from user.
	 * 
