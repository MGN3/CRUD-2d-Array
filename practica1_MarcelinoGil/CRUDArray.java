...
public class CRUDArray {
	/**
	 * @description Main method that executes the program. There are 4 main options: Create, Read, Update, Delete. There is another optiop to finish de program.
	 * @param args
	 */
	public static void main(String[] args) {

		// This 2d array is initialiced to test the database.
		String[][] product = { { "", "", "2222" }, { "2", "3" }, { "1", "1", "1" }, { "1", "2", "3", "4", "5", "6" },
				{ "", "", "" } };
		...
		do {
			...
			case 1:
				...
				case 1:
					...
					product = CreateUtilities.create2DArray();
					break;
				...
				doSomethingElse = Utilities.getCharMenu('y', 'n', "Do you want to do anything else?");
			...
			case 4:
				...
				// Request and return the desired option.
				menuChoice = Utilities.getIntBetween(1, 5,
						"Press '1' to remove the first coincidence. \nPress '2' to remove all the coincidences. \nPress '3' to remove all. \nPress '4' to restart the database. \nPress '5' to exit.");
				switch (menuChoice) {

				case 1:
					// Gives the option to remove all data from the row where a match occurred.
					DeleteUtilities.deleteFirstMatch(product, Utilities.getString("What do you want to delete?"));
					break;
				...
				case 4:
					// To erase database.
					product = DeleteUtilities.eraseDatabase(1, 0);
					break;
				case 5:
					// Exits sub menu.
					break;
